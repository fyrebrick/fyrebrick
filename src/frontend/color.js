module.exports.getColorInlineStyle = (color_name) => {
    ...
    switch (color_name) {
        ...
        case "Trans-Yellow":
            ...
            break;
        case "Trans-Red":
            css = "background-color: #9C0010;color:#FFF !important";
            break;
        case "Chrome Gold":
        ...
        case "Milky White":
            ...
            break;
        case "Trans-Black":
            css = "background-color:#939484;color:#000";
            break;
        ...
        case "Very Light Bluish Gray":
            css = "background-color:#747472;color:#FFF'"
            break;
        case "Trans-Green":
            css = "background-color:#188d33;color:#FFF'"
            break;
        case "Metallic Silver":
            css = 'color:#000;background: rgb(60,71,73);\n' +
